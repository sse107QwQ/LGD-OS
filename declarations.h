...
#endif
// 版本
#define LGD_OS_VERSION "v1.2 builds2026932108"
...
typedef struct {
    char *name;
    int (*func)(ShellContext *, int, char *[], FILE *, FILE *);
    char *brief;
    char *detail;
    unsigned char hidden;   // 1=隐藏（不在help列表显示），0=正常
} Command;
...
int cmd_exec(ShellContext *ctx, int argc, char *argv[], FILE *in, FILE *out);
